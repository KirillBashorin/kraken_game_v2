...
export default class FoeGenerator {
    ...
    */
    createPath() {
        ...
        const start = Phaser.Math.Between(64, 150);
        ...
        for (let i = 0; i < max; i++) {
            if (i % 2 === 0) {
                ...
                this.path.lineTo(start + 500, 50 + h * (i + 1));
            }
        }
    ...
    */
    wave(difficulty = 5) {
        this.createPath();
        // const x = Phaser.Math.Between(64, this.scene.width - 64);
        // const y = Phaser.Math.Between(-100, 0);
        // const minus = Phaser.Math.Between(-1, 1) > 0 ? 1 : -1;
    ...
    */
    addToWave(i) {
        ...
        const foe = new Foe(
            this.scene,
            Phaser.Math.Between(32, this.scene.width - 32) + i * horizontalOffset,
            i * verticalOffset,
            "foe0"
        );
        this.scene.tweens.add({
