const TYPES = {
  chocolate: { color: 0xaf8057, radius: 8, intensity: 0.4 },
  vanila: { color: 0xfff6d5, radius: 8, intensity: 0.4 },
  fruit: { color: 0xffffff, radius: 8, intensity: 0.4 },
  water: { color: 0xffffff, radius: 8, intensity: 0.4 },
  foe: { color: 0x00ff00, radius: 8, intensity: 0.4 },
};
