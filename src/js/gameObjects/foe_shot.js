const TYPES = {
  chocolate: { color: 0xaf8057, radius: 10, intensity: 0.4 },
  vanila: { color: 0xfff6d5, radius: 10, intensity: 0.4 },
  fruit: { color: 0x00ff00, radius: 10, intensity: 0.4 },
  water: { color: 0x0000cc, radius: 10, intensity: 0.4 },
  foe: { color: 0xfff01f, radius: 10, intensity: 0.4 },
};
...
class FoeShot extends Phaser.GameObjects.PointLight {
  constructor(
    ...
    if (playerName === "boss") this.body.setVelocity(velocityX, velocityY);
